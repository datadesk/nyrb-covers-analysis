...
for filepath in `pwd`/quantized/*; do
	...
	convert $filepath -format %c histogram:info:histogram_image.txt & sort -n histogram_image.txt | tail -1 
	convert $filepath -format %c histogram:info:histogram_image.txt & sort -n histogram_image.txt | tail -1 
	convert $filepath -format %c histogram:info:histogram_image.txt & sort -n histogram_image.txt | tail -1 
	convert $filepath -format %c histogram:info:histogram_image.txt & sort -n histogram_image.txt | tail -1 
	convert $filepath -format %c histogram:info:histogram_image.txt & sort -n histogram_image.txt | tail -1 
	convert $filepath -format %c histogram:info:histogram_image.txt & sort -n histogram_image.txt | tail -5 >> `pwd`/palettes.txt
done
